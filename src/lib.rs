...
pub fn resultados (test_data: TestData) {
    ...
    draw_text("Tensiones", x+600.0, y-y_step, font_size, BLACK);
    draw_text("Tension 1", x+600.0, y+y_step*1.0, font_size, BLACK);
    draw_text("Tension 2", x+600.0, y+y_step*5.0, font_size, BLACK);
    draw_text("Tension 3", x+600.0, y+y_step*10.0, font_size, BLACK);
